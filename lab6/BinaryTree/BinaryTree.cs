...
namespace BinaryTree
{
    ...
    public class BinaryTree<T> where T : IComparable
    {
        ...
        /// <summary>
        /// Обходит дерева в глубину прямым способом
        /// </summary>
        /// <param name="current"></param>
        /// <param name="result"></param>
        /// <returns></returns>
        public string NLR(BinaryTreeNode<T> current, ref string result)
        {
            result += current.Data.ToString() + " ";
            if (current.LeftNode != null)
            {
                NLR(current.LeftNode, ref result);
            }
            if (current.RightNode != null)
            {
                NLR(current.RightNode, ref result);
            }
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public string BFS(BinaryTreeNode<T> current, ref string result, Queue<BinaryTreeNode<T>> q = null)
        {
        ...
        /// <param name="current"></param>
        /// <param name="result"></param>
        public void Simetrical(BinaryTreeNode<T> current, ref string result)        
        {
            if (current != null)
            {
                Simetrical(current.LeftNode, ref result);
                result += current.Data.ToString() + " ";
                Simetrical(current.RightNode, ref result);
            }            
        }
        ...
        /// <param name="current"></param>
        /// <param name="result"></param>
        public void LRN(BinaryTreeNode<T> current, ref string result)
        {
            if (current != null)
            {
                LRN(current.LeftNode, ref result);                
                LRN(current.RightNode, ref result);
                result += current.Data.ToString() + " ";
            }
        }
